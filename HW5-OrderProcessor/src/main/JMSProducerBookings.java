...
public class JMSProducerBookings {
    ...
    // connection factory
        ...
        public void init(Context ctx, String queueName)
            ...
            qconFactory = (QueueConnectionFactory) ctx.lookup(Config2.JMS_FACTORY);
        ...
        public void send(String queueName, String message) throws Exception {
            ...
            env.put(Context.INITIAL_CONTEXT_FACTORY, Config2.JNDI_FACTORY);
            env.put(Context.PROVIDER_URL, Config2.PROVIDER_URL);
        ...
        public static void main(String[] args) throws Exception {
            // input arguments
            String msg = args[0];
            String queueName = "BookingsQueue" ;
 
            // create the producer object and send the message
            JMSProducerBookings producer = new JMSProducerBookings();
